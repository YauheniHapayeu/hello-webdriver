...
public class googleCloudPricingCalculatorForm {
    ...
    @FindBy(xpath = "//md-tab-item/div[@title=\"Compute Engine\"][@class=\"tab-holder compute\"]")
    ...
    public googleCloudPricingCalculatorForm computeEngineFormSelection() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//md-tab-item/div[@title=\"Compute Engine\"][@class=\"tab-holder compute\"]")));
        computeEngine.click();
        return this;
    }
    ...
    public googleCloudPricingCalculatorForm addGPUTypeSelection() {
        ...
        Duration Sec10 = Duration.ofSeconds(10);
        WebDriverWait wait = new WebDriverWait(driver, Sec10);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"select_option_456\"]/div[1]")));
        WebElement elementType = driver.findElement(By.xpath("//*[@id=\"select_option_456\"]/div[1]"));
        elementType.click();
        return this;
    }
